    ...
    public class SerializedExpressionEditor
    {
        ...
        public SerializedExpressionEditor(SerializedObject serializedObject,
            PreviewSceneManager previewSceneManager) : this(
                serializedObject, (xCVMExpression)serializedObject.targetObject, previewSceneManager)
        { }

        public SerializedExpressionEditor(xCVMExpression expression,
            PreviewSceneManager previewSceneManager) : this(
                new SerializedObject(expression), expression, previewSceneManager)
        { }

        public SerializedExpressionEditor(SerializedObject serializedObject, xCVMExpression targetObject,
        ...
        public bool Draw(out xCVMExpression bakeValue)
        {
            m_changed = false;
            ...
            EditorGUILayout.ObjectField("Current clip",
                m_targetObject, typeof(xCVMExpression), false);
            GUI.enabled = true;
