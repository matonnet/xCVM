...
namespace xCVM
{
    [CustomEditor(typeof(xCVMExpression))]
    public class ExpressionEditor : Editor
    {
        ...
        void Initialize()
        {
            m_target = (xCVMExpression)target;
        ...
        xCVMExpression m_target;
        xCVMExpression CurrentExpression()
        {
            return m_target;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_scene == null)
            {
                ...
                {
                    m_scene = xCVM.PreviewSceneManager.GetOrCreate(m_target.Prefab);
                    if (m_scene != null)
                    {
            ...
            if (m_scene != null)
            {
                ...
                if (m_serializedEditor.Draw(out xCVMExpression bakeValue))
                {
                    changed = true;
                }
                if (changed)
