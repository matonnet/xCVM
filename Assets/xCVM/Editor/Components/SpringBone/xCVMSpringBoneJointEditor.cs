...
namespace xCVM
{
    [CustomEditor(typeof(xCVMSpringBoneJoint))]
    [CanEditMultipleObjects]
    class xCVMSpringBoneJointEditor : Editor
    {
        private xCVMSpringBoneJoint m_target;
        ...
        void OnEnable()
        {
            ...
            m_target = (xCVMSpringBoneJoint)target;

            m_stiffnessForceProp = serializedObject.FindProperty(nameof(xCVMSpringBoneJoint.m_stiffnessForce));
            m_gravityPowerProp = serializedObject.FindProperty(nameof(xCVMSpringBoneJoint.m_gravityPower));
            m_gravityDirProp = serializedObject.FindProperty(nameof(xCVMSpringBoneJoint.m_gravityDir));
            m_dragForceProp = serializedObject.FindProperty(nameof(xCVMSpringBoneJoint.m_dragForce));
            m_jointRadiusProp = serializedObject.FindProperty(nameof(xCVMSpringBoneJoint.m_jointRadius));
        }
