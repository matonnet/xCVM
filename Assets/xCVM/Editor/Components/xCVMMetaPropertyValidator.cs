...
namespace xCVM
{
    delegate (string, MessageType) xCVMMetaPropertyValidator(SerializedProperty prop);

    class xCVMMetaProperty
    {
        public SerializedProperty m_prop;

        xCVMMetaPropertyValidator m_validator;

        public xCVMMetaProperty(SerializedProperty prop,
            xCVMMetaPropertyValidator validator = null)
        {
            m_prop = prop;
            if (validator == null)
            {
