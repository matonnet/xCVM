...
namespace xCVM
{
    ...
    /// Bone Selector
    /// </summary>
    [EditorTool("vrm-1.0/Humanoid", typeof(xCVM.xCVMInstance))]
    public class xCVMBoneSelectorEditorTool : EditorTool
    {
        ...
        public override void OnToolGUI(EditorWindow window)
        {
            ...
            var root = Selection.activeGameObject?.GetComponent<xCVMInstance>();
            if (root == null)
            {
                return;
            }
