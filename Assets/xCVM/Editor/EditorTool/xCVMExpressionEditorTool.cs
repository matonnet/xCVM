...
namespace xCVM
{
    [EditorTool("vrm-1.0/Expression", typeof(xCVM.xCVMInstance))]
    class xCVMExpressionEditorTool : EditorTool
    {
        ...
        void ExpressionPreviewInPlay(xCVMObjectExpression expression, xCVMRuntimeExpression runtime)
        {
            if (expression == null)
            {
