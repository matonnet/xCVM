...
namespace xCVM
{
    [EditorTool("vrm-1.0/LookAt", typeof(xCVM.xCVMInstance))]
    class xCVMLookAtEditorTool : EditorTool
    {
        ...
        public override void OnToolGUI(EditorWindow window)
        {
            ...
            var root = Selection.activeTransform.GetComponent<xCVMInstance>();
            if (root == null)
            {
                return;
            }
        ...
        static void OnSceneGUILookAt(xCVMObjectLookAt lookAt, xCVMRuntimeLookAt runtime, xCVMObjectLookAt.LookAtTargetTypes lookAtTargetType, Transform lookAtTarget)
        {
            if (lookAtTargetType == xCVMObjectLookAt.LookAtTargetTypes.SpecifiedTransform && lookAtTarget != null)
            {
                {
                    EditorGUI.BeginChangeCheck();
