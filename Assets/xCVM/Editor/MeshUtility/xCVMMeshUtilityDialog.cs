...
namespace xCVM
{
    public class xCVMMeshUtilityDialog : EditorWindow
    {
        ...
        {
            var window =
                (xCVMMeshUtilityDialog)EditorWindow.GetWindow(typeof(xCVMMeshUtilityDialog));
            window.titleContent = new GUIContent(MENU_NAME);
            window.Show();
        }

        xCVMMeshUtility _meshUtility = new xCVMMeshUtility();
        ...
        private void Validate()
        {
            ...
            if (_exportTarget.GetComponent<xCVMInstance>() == null)
            {
