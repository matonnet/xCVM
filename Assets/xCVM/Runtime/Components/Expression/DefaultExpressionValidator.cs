...
namespace xCVM
{
    public sealed class DefaultExpressionValidator : IExpressionValidator
    {
        ...
        private readonly Dictionary<ExpressionKey, xCVMExpression> _expressions;

        private DefaultExpressionValidator(xCVMObjectExpression expressionAvatar)
        {
        ...
        {
            public IExpressionValidator Create(xCVMObjectExpression expressionAvatar)
            {
