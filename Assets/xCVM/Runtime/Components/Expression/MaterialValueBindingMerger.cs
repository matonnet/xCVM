...
namespace xCVM
{
    ...
    internal sealed class MaterialValueBindingMerger
    {
        ...
        void InitializeMaterialMap(Dictionary<ExpressionKey, xCVMExpression> clipMap, Transform root)
        {
        ...
        public void AccumulateValue(xCVMExpression clip, float value)
        {
            // material color
        ...
        public MaterialValueBindingMerger(Dictionary<ExpressionKey, xCVMExpression> clipMap, Transform root)
        {
