...
namespace xCVM
{
    ...
    //   }
    // }
    public static class xCVMPoseLoader
    {
        ...
        static void LoadHumanPose(xCVMAnimationInstance instance,
        ...
        static void LoadExpressions(xCVMAnimationInstance instance,
        ...
        static void LoadLookAt(xCVMAnimationInstance instance,
        ...
        public static async Task<xCVMAnimationInstance> LoadVrmAnimationPose(string text)
        {
            ...
            var instance = gltfInstance.GetComponent<xCVMAnimationInstance>();
