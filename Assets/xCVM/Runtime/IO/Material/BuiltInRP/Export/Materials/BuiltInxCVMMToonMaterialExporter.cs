...
namespace xCVM
{
    public static class BuiltInxCVMMToonMaterialExporter
    {
        public static bool TryExportMaterialAsMToon(Material src, ITextureExporter textureExporter, out glTFMaterial dst)
        {
            ...
            mtoon.SpecVersion = xCVMExporter.MTOON_SPEC_VERSION;
            ...
            xCVMMaterialExportUtils.ExportTextureTransform(dst.pbrMetallicRoughness.baseColorTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(dst.emissiveTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(dst.normalTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.ShadeMultiplyTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.ShadingShiftTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.MatcapTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.RimMultiplyTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.OutlineWidthMultiplyTexture, scale, offset);
            xCVMMaterialExportUtils.ExportTextureTransform(mtoon.UvAnimationMaskTexture, scale, offset);
