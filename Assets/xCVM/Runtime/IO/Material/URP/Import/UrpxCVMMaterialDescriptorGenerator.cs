...
namespace xCVM
{
    public sealed class UrpxCVMMaterialDescriptorGenerator : IMaterialDescriptorGenerator
    {
        public MaterialDescriptor Get(GltfData data, int i)
        {
            // mtoon
            if (UrpxCVMMToonMaterialImporter.TryCreateParam(data, i, out var matDesc)) return matDesc;
            // unlit
