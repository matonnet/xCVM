...
namespace xCVM
{
    ...
    public static class MeshReader
    {
        ...
        ///  IndexBuffer
        /// </summary>
        static Mesh SharedBufferFromGltf(this glTFMesh x, xCVMImportData storage)
        {
            // 先頭を使う
        ...
        ///  IndexBuffer
        /// </summary>
        static Mesh FromGltf(this glTFPrimitives primitive, xCVMImportData storage, glTFMesh x)
        {
            return FromGltf(storage, x, primitive, false);
        }

        static Mesh FromGltf(xCVMImportData storage, glTFMesh x, glTFPrimitives primitive, bool isShared)
        {
        ...
        static VertexBuffer FromGltf(this gltfMorphTarget target, xCVMImportData storage)
        {
            var b = new VertexBuffer();
        ...
        public static MeshGroup FromGltf(this glTFMesh x, xCVMImportData storage)
        {
