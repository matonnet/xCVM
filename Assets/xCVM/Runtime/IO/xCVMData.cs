...
namespace xCVM
{
    public class xCVMData
    {
        ...
        public static GltfData Migrate(GltfData data, out xCVMData vrm1Data, out MigrationData migration)
        {
            ...
            try
            {
...

                {
                    ...
                    vrm1Data = new xCVMData(migratedData, vrm);
