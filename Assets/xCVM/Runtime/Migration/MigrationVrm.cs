...
[assembly: InternalsVisibleTo("xCVM.Tests")]
[assembly: InternalsVisibleTo("xCVM.Tests.PlayMode")]
...
namespace xCVM
{
    ...
    {
        public static byte[] Migrate(byte[] vrm0bytes, xCVMObjectMeta meta = null, Action<UniGLTF.glTF> modGltf = null)
        {
        ...
        /// <returns></returns>
        public static byte[] Migrate(GltfData data, xCVMObjectMeta meta = null, Action<UniGLTF.glTF> modGltf = null)
        {
            // VRM0 -> Unity
        ...
        static void MigrateVrm(glTF gltf, JsonNode vrm0, xCVMObjectMeta meta)
        {
...

            {
                ...
                {
                    SpecVersion = xCVMExporter.VRM_SPEC_VERSION
                };
                ...
                else
                {
                    ...
                    {
                        LicenseUrl = xCVMExporter.LICENSE_URL_JA,
                        AllowExcessivelySexualUsage = false,
                        AllowExcessivelyViolentUsage = false,
                        AllowPoliticalOrReligiousUsage = false,
                        AllowRedistribution = false,
                    };
                    xCVMExporter.ExportMeta(vrm1, meta, null);
                }
                // humanoid (required)
