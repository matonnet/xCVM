...
using UnityEngine;
using xCVM;
using xCVM.xCVMViewer;
using VRMShaders;

public class SimpleVrma : MonoBehaviour
{
    public xCVMInstance Vrm;

    public xCVMAnimationInstance Vrma;
    ...
    {
        Vrm = await xCVM.LoadPathAsync(path,
            canLoadVrm0X: true,
            showMeshes: false,
    ...
    async void LoadVrma(string path)
    {
        ...
        Vrma = instance.GetComponent<xCVMAnimationInstance>();
