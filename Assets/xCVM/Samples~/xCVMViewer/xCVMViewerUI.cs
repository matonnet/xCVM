...
{
    public class xCVMViewerUI : MonoBehaviour
    {
        [SerializeField]
        ...
        IxCVMAnimation m_src = default;
        public IxCVMAnimation Motion
        {
            get { return m_src; }
            set
            {
                ...
                TPose = new xCVMTPose(m_src.ControlRig.Item1.GetRawHipsPosition());
            }
        }

        public IxCVMAnimation TPose;
        ...
        private void Reset()
        {
            ...
            m_target = GameObject.FindObjectOfType<xCVMTargetMover>().gameObject;
        }
        ...
        private void Start()
        {
            m_version.text = string.Format("VRMViewer {0}.{1}",
                    xCVMSpecVersion.MAJOR, xCVMSpecVersion.MINOR);
        ...
        private void Update()
        {
            ...
            if (m_loaded != null)
            {
                ...
                {
                    // Automatically retarget in xCVMRuntime.Process
        ...
        void OnOpenModelClicked()
        {
            ...
            var path = xCVMFileDialogForWindows.FileDialog("open VRM", "vrm");
#elif UNITY_EDITOR
        ...
        {
#if UNITY_STANDALONE_WIN
            var path = xCVMFileDialogForWindows.FileDialog("open Motion", "bvh", "gltf", "glb");
#elif UNITY_EDITOR
            ...
            Motion = instance.GetComponent<xCVMAnimationInstance>();
        ...
        async void OnPastePoseClicked()
        {
            ...
            try
            {
                Motion = await xCVMPoseLoader.LoadVrmAnimationPose(text);
            }
        ...
        async void LoadModel(string path)
        {
            ...
            try
            {
                ...
                var xCVMInstance = await xCVM.LoadPathAsync(path,
                    canLoadVrm0X: true,
                    showMeshes: false,
                ...
                {
                    UnityObjectDestroyer.DestroyRuntimeOrEditor(xCVMInstance.gameObject);
                ...
                var instance = xCVMInstance.GetComponent<RuntimeGltfInstance>();
                instance.ShowMeshes();
