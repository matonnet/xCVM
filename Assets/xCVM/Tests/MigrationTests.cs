    ...
    public class MigrationTests
    {
        ...
        public void Migrate_VrmTestModels()
        {
            ...
            foreach (var gltf in EnumerateGltfFiles(root))
            {
                try
                {
                    xCVM.LoadPathAsync(gltf.FullName, true, controlRigGenerationOption: ControlRigGenerationOption.None).Wait();
                }
        ...
        public void MigrateMeta()
        {
            ...
            {
                using (var migrated = xCVMData.Migrate(data, out xCVMData vrm, out MigrationData migration))
                {
                    Assert.NotNull(vrm);
        ...
        public void MigrateMaterials()
        {
            ...
            var instance106 = xCVM.LoadBytesAsync(model106, awaitCaller: new ImmediateCaller()).Result;
            ...
            var instance107 = xCVM.LoadBytesAsync(model107, awaitCaller: new ImmediateCaller()).Result;
