...
namespace xCVM
{
    public class SerializationTests
    {
        ...
        //     // asset => vrmlib
        //     var converter = new xCVM.RuntimeVrmConverter();
        ...
        //     // var dst = xCVM.RuntimeUnityMaterialBuilder.CreateMaterialAsset(loaded, hasVertexColor: false, map);
        //     // dst.name = src.name;
        ...
        public void ExpressionTest()
        {
...

            {
                ...
                // // export
                // var gltf = xCVM.ExpressionAdapter.ToGltf(expression, new List<UniGLTF.Extensions.VRMC_vrm.Node>(), new List<UniGLTF.Extensions.VRMC_vrm.Material>());
                ...
                // // import
                // var imported = xCVM.ExpressionAdapter.FromGltf(gltf, new List<UniGLTF.Extensions.VRMC_vrm.Node>(), new List<UniGLTF.Extensions.VRMC_vrm.Material>());
